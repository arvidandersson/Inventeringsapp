...
save.addEventListener('click', function(){
	...
	memo = Titanium.Filesystem.getFile(Titanium.Filesystem.applicationDataDirectory, filename);
	...
	try{
	     db.execute('INSERT INTO Voismemo (URL, AnnotationID) VALUES (?,?)', filename, Ti.App.AnnotationID);
